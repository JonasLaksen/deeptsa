...
def main(bidir_seq=0, gen_epochs=0, spec_epochs=0, load_gen=True, load_spec=False):
...
main(bidir_seq=100, gen_epochs=100, spec_epochs=11, load_gen=False, load_spec=False)
